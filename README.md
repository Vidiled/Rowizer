...
|highlight| new                          | | Controls which appointments are highlighted: `new` (modified after 8:00), `cancelled` (vervalt), `both`, or `false`/`off`/`none` to disable highlighting. Default: `new`. |
